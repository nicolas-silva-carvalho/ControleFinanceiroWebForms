<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PaginaCadastro.aspx.cs" Inherits="Financeiro.Site.PaginaCadastro" %>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <asp:Button runat="server" OnClick="Enviar" Text="Cadastrar" CssClass="btn btn-primary m-1" />
                </div>
            </div>
        </div>
    </div>
